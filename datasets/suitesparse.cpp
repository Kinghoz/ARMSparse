...
int main(int argc, char *argv[]){
    //suitesparse dataset
    string path = "datasets/Olivetti_norm_10NN.mtx";
    ifstream fp(path);
    ...
    // for(int i=0;i<nnz;i++) cout << rowPtr2[i] << " ";
    // cout << endl;
    // for(int i=0;i<nnz;i++) cout << colInd2[i] << " ";
    // cout << endl;
    // for(int i=0;i<nnz;i++) printf("%.2f ", val2[i]);
    // cout << endl;
    // for(int i=0;i<nnz;i++) cout << flag[i] << " ";
    // cout << endl;
    origin(rowPtr, colInd, val, B, C_compare3, M, K, N, threads);
